...
INSERT INTO Article values ('許誌中','問題','請問貓咪如何表示好感呢','貓在表示好感方面不如狗狗直白,以至於我們經常認為貓是不友善和冷漠的<br>但是感覺得出來其實滿是會表露好感的,只是貓咪是怎樣對人表示好感呢?','2016-04-01 20:22:28.447','0','/PuppyKitten/_100_images/貓咪.jpg');
INSERT INTO Article values ('何亭儀','心得','狗狗的餵食禁忌','１.不要讓幼犬有機會吞雞骨、排骨或魚骨、因為它們會滯留在咽喉裏，然後碎裂，如果不留在咽喉裏，就會滑進體內，刺穿胃壁和腸道。<br>２.不要讓幼犬吃人們的剩菜剩飯，因為愛犬對營養的需求和人類不同，若用人類的食譜調理狗食，不但費時費事，而且愛犬很難攝取到完整均衡的營養。<br>３.每餐飯之間不要給幼犬零食吃，如果牠服從其它訓練，可以給牠少許零食，以示鼓勵。<br>','2016-04-01 23:24:37.978','0','/PuppyKitten/_100_images/狗狗禁忌.jpeg');
...
INSERT INTO Article values ('管理員','公告','LINE的緊急公告','各位拔拔麻麻<br>2/1日起 我們接收下單<br>只會接收 生活LINE的單唷>"<<br>避免2/1日後下單沒有接收到您的單<br>要麻煩各位拔拔麻麻幫我動動手指 幫我加一下 <br>生活LINE ID → @meow<br>或是直接用好友掃QR code smile 表情符號<br>感謝各位拔拔麻麻囉>"<<br>ps: 相簿裡有圖示唷<br>不會的朋友可以照圖示操作唷 smile 表情符號<br>','2016-01-22 10:10:10.555','0','/PuppyKitten/_100_images/LINE.png');
